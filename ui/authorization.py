...
class Ui_WindowAuthorization(object):
    def setupUi(self, WindowAuthorization):
        ...
        WindowAuthorization.setWindowIcon(icon)
        WindowAuthorization.setStyleSheet("background: #fff")
        self.centralwidget = QtWidgets.QWidget(parent=WindowAuthorization)
...
"}")
        ...
        self.label_autor_text = QtWidgets.QLabel(parent=self.centralwidget)
        ...
        self.label_logo_721 = QtWidgets.QLabel(parent=self.centralwidget)
        ...
        self.lable_suppot_text = QtWidgets.QLabel(parent=self.centralwidget)
