...
"}")
        ...
        self.btn_nachinki = QtWidgets.QPushButton(self.centralwidget)
        self.btn_nachinki.setEnabled(True)
        self.btn_nachinki.setMinimumSize(QtCore.QSize(0, 65))
        self.btn_nachinki.setMaximumSize(QtCore.QSize(500, 65))
        self.btn_nachinki.setBaseSize(QtCore.QSize(0, 0))
        font = QtGui.QFont()
        font.setFamily("Trebuchet MS")
        font.setPointSize(22)
        font.setBold(False)
        font.setWeight(50)
        self.btn_nachinki.setFont(font)
        self.btn_nachinki.setStyleSheet("QPushButton {\n"
"background-color: rgb(228, 107, 134);\n"
"border: none;\n"
"border-radius: 10px}\n"
"\n"
...
"background-color: rgba(228, 107, 134, 1)\n"
"}")
        self.btn_nachinki.setCheckable(False)
        self.btn_nachinki.setObjectName("btn_nachinki")
        self.verticalLayout.addWidget(self.btn_nachinki)
        self.btn_rashodniki = QtWidgets.QPushButton(self.centralwidget)
        self.btn_rashodniki.setEnabled(True)
        self.btn_rashodniki.setMinimumSize(QtCore.QSize(0, 65))
        self.btn_rashodniki.setMaximumSize(QtCore.QSize(500, 65))
        self.btn_rashodniki.setBaseSize(QtCore.QSize(0, 0))
        font = QtGui.QFont()
        font.setFamily("Trebuchet MS")
        font.setPointSize(22)
        font.setBold(False)
        font.setWeight(50)
        self.btn_rashodniki.setFont(font)
        self.btn_rashodniki.setStyleSheet("QPushButton {\n"
"background-color: rgb(228, 107, 134);\n"
"border: none;\n"
"border-radius: 10px}\n"
"\n"
...
"background-color: rgba(228, 107, 134, 1)\n"
"}")
        self.btn_rashodniki.setCheckable(False)
        self.btn_rashodniki.setObjectName("btn_rashodniki")
        self.verticalLayout.addWidget(self.btn_rashodniki)
...
"}")
    ...
    def retranslateUi(self, WindowAutoOrders):
        ...
        self.btn_nachinki.setText(_translate("WindowAutoOrders", "НАЧИНКИ"))
        self.btn_rashodniki.setText(_translate("WindowAutoOrders", "РАСХОДНИКИ"))
